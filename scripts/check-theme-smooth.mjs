...
const PROBES = [
  ...
  // Реферального блока на сайте больше нет — вместе с ним ушли
  // пробы по его заливке, градиенту и свету. Взамен здесь стоят
  // два цветных материала лавки, которые остались: тёмная зелень
  // карточек условий и серый камень карточек витрины.
  ['карточка условия', '.term', 'backgroundColor'],
  ['текст на зелени', '.term__text', 'color'],
