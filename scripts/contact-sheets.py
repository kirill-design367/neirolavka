...
# Список обязан совпадать с именами, которые пишет screenshots.mjs:
# лист, собранный по устаревшим именам, молча выходит пустым.
ORDER = ['1-первый-экран', '2-витрина', '3-заказ-собран', '4-витрина-chatgpt',
         '5-как-устроено', '6-отзывы', '7-подвал']
TITLES = {
    '1-первый-экран': 'Навигация, шапка, первый экран, пустой чек',
    '2-витрина': 'Витрина продуктов',
    '3-заказ-собран': 'Заказ собран: товар, оплата, сумма, кнопка',
    '4-витрина-chatgpt': 'Витрина: выбран другой продукт',
    '5-как-устроено': 'Как это устроено — шаги на нити',
    '6-отзывы': 'Отзывы бегущей строкой',
    '7-подвал': 'Подвал: кто продаёт',
}
