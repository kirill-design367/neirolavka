...
const STEPS = [
  {
    ...
    text: 'Нейросеть, уровень подписки, способ оплаты. Что выбрали, то и уходит в бот — на последнем шаге ничего не меняется.',
  },
  {
    n: '2',
    title: 'Оформляете в боте',
    text: 'Кнопка открывает Telegram. Регистрация по номеру, заказ записывается сразу. Автоматической оплаты в боте пока нет: администратор напишет в тот же чат и скажет, как заплатить.',
  },
  {
    n: '3',
    title: 'Получаете доступ',
    text: 'Данные аккаунта приходят в тот же чат. Если что-то не сходится — пишете туда же, переписка сохраняется.',
  },
];
