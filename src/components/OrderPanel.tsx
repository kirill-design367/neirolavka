      ...
      <div className="order__paper">
        ...
        <div className="order__foot">
          ...
          <p className="order__fineprint">
            ...
            {botReady
              ? 'Заказ уходит в бот: регистрация по номеру, выдача доступа — там же. Оплата пока не автоматическая — администратор напишет в тот же чат и скажет, как заплатить. На сайте вводить ничего не нужно.'
